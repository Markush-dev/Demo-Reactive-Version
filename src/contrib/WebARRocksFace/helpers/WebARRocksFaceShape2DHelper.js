...
const WebARRocksFaceShape2DHelper = (function(){
  ...
  function create_glImageTexture(imageSpec){
    if (imageSpec.src){
  ...
  function build_shape(landmarkLabels, shapeSpecsArg, shapeIndex){
    ...
    return new Promise(function(accept, reject){
      ...
      // build textures:
      const texturesPromises = shapeSpecs.textures.map(create_glImageTexture);
...
export default WebARRocksFaceShape2DHelper;